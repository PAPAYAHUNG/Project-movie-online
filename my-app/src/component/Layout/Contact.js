...
export default function Contact() {
    return (
        <div>
            <div id="content">
                <div className="tn-section tn-contact-us container">
                    <div className="tn-section-content">
                        <div className="tn-section-title">
                            <h2 className='text-center tn-section-header'>Contact Us</h2>
                        </div>
                        <div className="tn-block">
                            <h5>Send your feedback</h5>
                            <p>Vo Van Ngan street, District Thu Duc, Ho Chi Minh City, Vietnam</p>
                        </div>
                        <div className="tn-block">
                            <h5>Support services (24 x 7)</h5>
                            <div className="tn-emails-and-phone-numbers">
                                ...
                                <ul className="tn-phone-numbers d-flex">
                                    <li><span className="tn-mobile-icon mr-2">
                                        <img src="https://cdn11.ticketnew.com/images/app-download-grey.svg" alt /></span></li>
                                    <li><span className="tn-phone-number">+84 776463985</span></li>
                                </ul>
                            </div>
                        </div>
                        <div className="tn-block">
                        ...
                        <div className="tn-block">
                            <h5>To advertise in the site</h5>
                            <div className="tn-emails-and-phone-numbers">
                                <ul className="tn-emails">
                                    <li><span className="tn-mail-icon">
                                        <img src="https://cdn11.ticketnew.com/images/mail-icon.png" alt /></span></li>
                        ...
                        <div className="tn-block">
                            <h5>Theatre owners/Event organisers want to sell tickets</h5>
                            <div className="tn-emails-and-phone-numbers">
                                <ul className="tn-emails">
                                    <li><span className="tn-mail-icon">
                                        <img src="https://cdn11.ticketnew.com/images/mail-icon.png" alt /></span></li>
                        ...
                        <div className="tn-block">
                            <h5>To build business alliance</h5>
